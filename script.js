...
const previousOperandTextElement = document.querySelector('[data-firstNumberOperator]')
const currentOperandTextElement = document.querySelector('[data-secondNumberOperator]')
